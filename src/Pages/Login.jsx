    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md backdrop-blur-xl bg-white/70 border border-white/40 shadow-2xl rounded-3xl p-8">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Access your secure vault</p>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <button onClick={() => navigate("/register")} className="mt-3 px-5 py-2 rounded-full bg-white shadow hover:shadow-md border border-gray-200 text-sm transition">
            Open an account
          </button>
        </div>
      </div>
